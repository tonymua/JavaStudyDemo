 ...
 *
 * @author:
 * @date: created in 9:24 2020/10/29
 * @version:
 */
    ...
    public static void main(String[] args) {
        try {
            ...
            for (int i = 0; i < 3000000; i++) {
                bufferedWriter.write(String.valueOf(genId()) + "\n");
            }

            BufferedReader bufferedReader = new BufferedReader(new FileReader(file));
            long line = Files.lines(Paths.get(String.valueOf(file))).count();
            ...
            System.out.println("共生成id[" + line + "]个，花费时间[" + (end - start) + "]毫秒");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
